...
export function Home() {
  const popularProducts = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=800',
    ...
    },
    {
      ...
      image:
        'https://i.pinimg.com/originals/00/07/8c/00078c3a5782b1367a6cdfcc03f710a9.jpg',
  ...
  const testimonials = [
    {
      name: 'Marri Sireesha',
      image:
        'https://res.cloudinary.com/dp5t3oidu/image/upload/v1750184950/WhatsApp_Image_2025-06-17_at_23.57.23_626dd741_ry48oe.jpg',
    ...
    },
    {
      ...
      image:
        'https://res.cloudinary.com/dp5t3oidu/image/upload/v1750184987/WhatsApp_Image_2025-06-17_at_23.57.23_8da645ad_oeoavn.jpg',
    ...
    },
    {
      name: 'Meera ',
      image:
        'https://res.cloudinary.com/dp5t3oidu/image/upload/v1750322385/WhatsApp_Image_2025-06-19_at_00.13.58_1da06394_tmqpnr.jpg',
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[80vh] flex items-center px-4 md:px-8">
        <div
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            ...
            <Link
              to="/stores"
              className="btn-primary bg-white bg-opacity-20 hover:bg-opacity-30"
            >
              Find a Store
            </Link>
          </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-800 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8">
            We bring the authentic taste of Udupi to your kitchen with our fresh, hand-ground batters and
            chutneys. Every product is made with love, following traditional recipes passed down through
            generations.
          </p>
        </div>
      </section>
      ...
      {/* Social Media */}
      <section className="py-16 bg-white dark:bg-gray-800 px-4 text-center">
